...
const Store = (function() {
  ...
  const EMBEDDED_SAT_SOP = {
    ...
    "phases": [
      {"id":"sat-1","sortOrder":1,"name":"1. 外观检查","steps":["集装箱外观检查","电池簇/高压箱/消防/汇流柜/液冷检查","线束连接复核","接地检测"],"checks":[
        {"id":"sat-1-1","item":"集装箱舱体外观","content":"目视全舱表面，无凹陷/划伤/锈蚀/焊缝裂纹，螺栓紧固，铭牌清晰","standard":"GB/T 36276-2018","type":"重要","tool":"目视法/手电筒","record":"外观检查记录表"},
        {"id":"sat-1-2","item":"电池簇外观清洁度","content":"电芯模组无脏秽/损伤/划痕，标识清晰正确","standard":"厂家规范","type":"重要","tool":"目视法","record":"外观检查记录表"},
        {"id":"sat-1-3","item":"高压箱PDU外观","content":"清洁无秽物/损伤/锈蚀，标识清晰","standard":"GB/T 36276-2018","type":"重要","tool":"目视法","record":"外观检查记录表"},
        {"id":"sat-1-4","item":"消防系统外观","content":"探测器/喷头无堵塞，管路无老化/松动，灭火剂储量≥90%","standard":"GB 50116-2013","type":"关键","tool":"目视法/手电筒","record":"消防检查记录表"},
        {"id":"sat-1-5","item":"液冷系统外观","content":"管道外表面清洁无裂纹/凹陷，风机泵无移位松动","standard":"厂家技术规范","type":"重要","tool":"目视法/红外成像仪","record":"液冷检查记录表"},
        {"id":"sat-1-6","item":"汇流柜/配电柜外观+扭矩","content":"外观清洁+高压电缆与铜排锁附扭矩符合标准","standard":"GB 50303-2015","type":"关键","tool":"目视法/数显扭矩扳手(东力CNB100)","record":"扭矩检查记录表"},
        {"id":"sat-1-7","item":"高低压线束接线复核","content":"对照电气原理图核对动力/通讯线束:安装紧固、位置正确、线标清晰、MSD安装到位","standard":"GB 50171-2012","type":"关键","tool":"目视法/插拔试验","record":"线束检查记录表"},
        {"id":"sat-1-8","item":"门锁/铰链/密封条功能","content":"开关门3次，确认锁闭可靠无卡滞，密封条完好","standard":"GB/T 36276-2018","type":"一般","tool":"目视法","record":"外观检查记录表"},
        {"id":"sat-1-9","item":"通风口滤网清洁度","content":"进/出风口滤网无堵塞/破损","standard":"厂家规范","type":"一般","tool":"目视法","record":"外观检查记录表"}
      ],"witness":"业主代表/监理"},
      {"id":"sat-2","sortOrder":2,"name":"2. 绝缘电阻试验","steps":["直流侧绝缘电阻测量","交流侧绝缘电阻测量","接地电阻测试","漏电流/BMS绝缘监测验证"],"checks":[
        {"id":"sat-2-1","item":"电池簇DC+/DC-对PE绝缘电阻","content":"断开断路器，用兆欧表DC2500V档测试60s，绝缘≥20MΩ","standard":"GB 50150-2016","type":"关键","tool":"兆欧表 DC 2500V (MIT525)","record":"绝缘测试记录表"},
        {"id":"sat-2-2","item":"高压箱输入/输出对地绝缘","content":"闭合断路器，用兆欧表DC2500V档分别测B+/B-/P+/P-对把手绝缘60s，≥550MΩ(带BMS)","standard":"GB 50150-2016","type":"关键","tool":"兆欧表 DC 2500V (MIT525)","record":"绝缘测试记录表"},
        {"id":"sat-2-3","item":"交流侧相间/对地绝缘","content":"用1000V兆欧表测量A-B/B-C/C-A相间及对地绝缘，≥10MΩ","standard":"GB 50150-2016","type":"关键","tool":"兆欧表 DC 1000V","record":"绝缘测试记录表"},
        {"id":"sat-2-4","item":"辅助回路/控制电源绝缘","content":"控制电源端子-地对地绝缘测试，≥10MΩ","standard":"GB 50150-2016","type":"重要","tool":"兆欧表 DC 500V","record":"绝缘测试记录表"},
        {"id":"sat-2-5","item":"直流舱体接地电阻","content":"用万用表/接地电阻测试仪测量舱体外接地铜排阻值<4Ω","standard":"GB 50169-2016","type":"关键","tool":"万用表欧姆档/接地电阻测试仪(0-200Ω)","record":"接地测试记录表"},
        {"id":"sat-2-6","item":"电池簇接地电阻","content":"测量电池接地线对接地铜排阻值<0.1Ω","standard":"GB 50169-2016","type":"关键","tool":"万用表欧姆档","record":"接地测试记录表"},
        {"id":"sat-2-7","item":"高压箱接地电阻","content":"测量高压箱接地线对接地铜排阻值<0.1Ω","standard":"GB 50169-2016","type":"关键","tool":"万用表欧姆档","record":"接地测试记录表"},
        {"id":"sat-2-8","item":"BMS绝缘监测功能验证","content":"通过BMS屏显读取绝缘电阻值，确认≥2MΩ且与实测值趋势一致","standard":"GB/T 34131-2017","type":"重要","tool":"BAMS显示屏","record":"BMS功能测试记录表"},
        {"id":"sat-2-9","item":"极性确认正确","content":"万用表确认DC+/-极性与图纸一致","standard":"GB 50150-2016","type":"关键","tool":"数字万用表(6位半,1500VDC)","record":"电压检测记录表"},
        {"id":"sat-2-10","item":"环境温湿度记录(推荐)","content":"记录测试时环境温湿度，必要时修正读数","standard":"DL/T 596-2021","type":"推荐","tool":"温湿度计","record":"环境参数记录"}
      ],"witness":"业主代表"},
      {"id":"sat-3","sortOrder":3,"name":"3. 耐压试验","steps":["直流侧耐压","交流侧耐压","泄漏电流监测"],"checks":[
        {"id":"sat-3-1","item":"直流耐压试验","content":"升压至2500VAC保持60s无击穿闪络","standard":"GB 50150-2016","type":"关键","tool":"耐压测试仪","record":"耐压试验记录表"},
        {"id":"sat-3-2","item":"交流侧工频耐压","content":"按系统电压等级施加对应耐压值保持60s","standard":"GB 50150-2016","type":"关键","tool":"耐压测试仪","record":"耐压试验记录表"},
        {"id":"sat-3-3","item":"泄漏电流监测","content":"耐压过程中监测泄漏电流≤10mA","standard":"GB/T 16927.1-2011","type":"重要","tool":"耐压测试仪","record":"耐压试验记录表"},
        {"id":"sat-3-4","item":"耐压后复测绝缘(推荐)","content":"耐压后重新测量绝缘电阻≥试验前值90%","standard":"GB 50150-2016","type":"推荐","tool":"兆欧表 DC 2500V","record":"绝缘测试记录表"}
      ],"witness":"业主代表/厂家代表"},
      {"id":"sat-4","sortOrder":4,"name":"4. 通讯调试","steps":["CAN总线通讯","Modbus TCP/RTU通讯","EMS/SCADA接入","485设备联调","冗余切换验证"],"checks":[
        {"id":"sat-4-1","item":"CAN总线通讯(BMS内网)","content":"ZLG CAN盒连接主控-从控CAN0口，验证500K波特率通信正常、帧无错误","standard":"高特内部协议","type":"关键","tool":"ZLG CAN盒(周立功USBCAN-2E-U)","record":"CAN通讯测试记录表"},
        {"id":"sat-4-2","item":"Modbus TCP通讯(BMS-PCS)","content":"BMS→PCS Modbus TCP数据点表逐项核对，响应时间<100ms","standard":"GB/T 36547-2018","type":"关键","tool":"笔记本+Modbus Poll/网线测试仪","record":"Modbus通讯记录表"},
        {"id":"sat-4-3","item":"SCADA/EMS上位机通讯","content":"EMS通过IEC61850/Modbus与BAU通信，数据采集点表完整、遥测遥信响应≤2s","standard":"IEC 61850 / GB/T 37593-2019","type":"关键","tool":"上位机软件/网络测试仪","record":"EMS通讯测试记录表"},
        {"id":"sat-4-4","item":"RS485设备通讯-温湿度(×3)","content":"BMS→3台温湿度计Modbus RTU 9600bps通信，温湿度数据显示正确","standard":"MC06~MC50协议","type":"重要","tool":"BAMS显示屏","record":"动环通讯记录表"},
        {"id":"sat-4-5","item":"RS485设备通讯-空调/液冷","content":"BMS→空调(1台)+液冷机组(1台)通信，运行状态/温度数据正确","standard":"LCI-600CR协议 9600bps","type":"重要","tool":"BAMS显示屏","record":"动环通讯记录表"},
        {"id":"sat-4-6","item":"RS485设备通讯-电表/IO/除湿机","content":"BMS→电表(1)+IO模块(1)+除湿机(2)通信，数据/状态正确","standard":"Modbus RTU 9600bps","type":"重要","tool":"BAMS显示屏","record":"动环通讯记录表"},
        {"id":"sat-4-7","item":"水浸传感器信号验证","content":"打湿/短接水浸探头，BMS/上位机显示报警，擦干后消除，历史记录完整","standard":"厂家规范","type":"重要","tool":"BAMS显示屏/水","record":"消防/水浸测试记录表"},
        {"id":"sat-4-8","item":"消防系统干接点联动","content":"触发消防故障/告警/喷洒干接点，BMS显示对应状态","standard":"GB 50116-2013","type":"关键","tool":"BAMS显示屏/消防主机","record":"消防联动测试记录表"},
        {"id":"sat-4-9","item":"数据采集点表完整性","content":"对照IO清单核查模拟量/数字量齐全，无遗漏点位","standard":"GB/T 36995-2019","type":"重要","tool":"上位机软件","record":"IO点位核对表"},
        {"id":"sat-4-10","item":"通讯线缆标识检查","content":"每根网线/485线两端均有标签且一致，路由合理","standard":"GB/T 36547-2018","type":"一般","tool":"目视法","record":"通讯布线检查表"},
        {"id":"sat-4-11","item":"冗余链路切换测试","content":"断开主通讯链路，验证备用自动切换，丢包率≤1%","standard":"IEC 61850","type":"推荐","tool":"网络测试仪","record":"冗余切换测试表"}
      ],"witness":"安装/调试工程师"},
      {"id":"sat-5","sortOrder":5,"name":"5. 充放电测试","steps":["上电前准备","BMS阈值确认","SOC标定","0.2P充电","满功率循环充放电","停机验证","数据导出"],"checks":[
        {"id":"sat-5-1","item":"BMS保护阈值检查","content":"对照需求确认表§12.2核对BAMS阈值设置与定值单一致（过压/欠压/过流/温度/绝缘等）","standard":"需求确认表 B2-X1","type":"关键","tool":"BAMS显示屏/定值单","record":"阈值核对记录表"},
        {"id":"sat-5-2","item":"直流舱系统整体上高压","content":"按顺序合QF2→QF1→QF3→QF8→UPS→空调/除湿→照明→PS/PW→消防→隔离开关ON，BMS自检→预充→吸合主接触器","standard":"厂家操作规程","type":"关键","tool":"BAMS显示屏/万用表","record":"上电操作记录表"},
        {"id":"sat-5-3","item":"SOC初始标定/OCV比对","content":"静置后OCV标定初始SOC，误差≤±1%","standard":"GB/T 36548-2018","type":"关键","tool":"BMS调试软件/万用表","record":"SOC标定记录表"},
        {"id":"sat-5-4","item":"BMS采样精度验证","content":"通过BMS屏显核对单体电压(52个/包)和温度(28个+2极柱)采集准确，通信正常","standard":"GB/T 34131-2017","type":"关键","tool":"BAMS显示屏","record":"BMS采样精度记录表"},
        {"id":"sat-5-5","item":"0.2P恒功率充电(阶梯升功率)","content":"500kW起步每5min增500kW至2500kW充电5min，静置10min，过程无告警跳闸","standard":"GB/T 36548-2018","type":"关键","tool":"BAMS显示屏/功率分析仪","record":"充电测试记录表"},
        {"id":"sat-5-6","item":"0.2P恒功率放电(阶梯降功率)","content":"500kW起步每5min增500kW至2500kW放电至截止，静置30min","standard":"GB/T 36548-2018","type":"关键","tool":"BAMS显示屏/功率分析仪","record":"放电测试记录表"},
        {"id":"sat-5-7","item":"均衡功能验证","content":"观察静置后单体电压差≤20mV，BMS均衡投切逻辑及状态正常","standard":"GB/T 36276-2018","type":"重要","tool":"BMS调试软件","record":"均衡功能记录表"},
        {"id":"sat-5-8","item":"充电效率检测","content":"记录充入能量/电网输入能量比值≥93%","standard":"GB/T 36548-2018","type":"关键","tool":"功率分析仪/电能质量分析仪","record":"效率测试记录表"},
        {"id":"sat-5-9","item":"容量衰减检测","content":"实测可用容量与额定容量对比，衰减<3%","standard":"GB/T 36276-2018","type":"关键","tool":"BMS调试软件","record":"容量测试记录表"},
        {"id":"sat-5-10","item":"温升监测","content":"热成像仪扫描电芯/模组/铜排最大温升≤15K(满功率)","standard":"GB/T 36276-2018","type":"关键","tool":"红外测温仪(-20~500℃)","record":"热成像巡检报告"},
        {"id":"sat-5-11","item":"SOC校准验证","content":"满充后SOC=100%±2%，满放后SOC=0%±2%","standard":"GB/T 36548-2018","type":"重要","tool":"BAMS显示屏","record":"SOC校准记录表"},
        {"id":"sat-5-12","item":"循环充放电测试(满功率)","content":"0.2P满充→0.2P满放→满功率循环充放电各1次，SOC停在40%±10%","standard":"GB/T 36548-2018","type":"关键","tool":"BAMS显示屏/功率分析仪","record":"循环充放电记录表"},
        {"id":"sat-5-13","item":"系统停机测试","content":"按顺序分闸:隔离开关OFF→消防/照明/设备/液冷/UPS→配电柜→静置5min万用表确认0V","standard":"厂家操作规程","type":"关键","tool":"万用表","record":"停机操作记录表"},
        {"id":"sat-5-14","item":"充放电数据导出检查","content":"导出USB/SD中充放电数据，检查数据完整性、准确性","standard":"GB/T 36995-2019","type":"重要","tool":"笔记本电脑","record":"数据导出检查表"}
      ],"witness":"业主代表/厂家代表"},
      {"id":"sat-6","sortOrder":6,"name":"6. 保护功能验证","steps":["电压保护","电流保护","温度保护","级差/SOC保护","绝缘/通信保护","硬件/逻辑保护"],"checks":[
        {"id":"sat-6-1","item":"单体过压保护(3.55/3.6/3.65V)","content":"模拟单体>各阈值电压，验证PCS停止充电/降流/跳机动作，回差0.1V","standard":"GB/T 34131-2017 §12.2-1","type":"关键","tool":"BAMS显示屏/上位机","record":"保护功能验证记录表"},
        {"id":"sat-6-2","item":"单体欠压保护(2.85/2.8/2.7V)","content":"模拟单体<各阈值电压，验证停止放电/降流/跳机动作","standard":"GB/T 34131-2017 §12.2-2","type":"关键","tool":"BAMS显示屏/上位机","record":"保护功能验证记录表"},
        {"id":"sat-6-3","item":"总压过压/欠压保护","content":"模拟总压超出范围(1185~1500V)，验证保护动作","standard":"GB/T 34131-2017 §12.2-11/12","type":"关键","tool":"BAMS显示屏","record":"保护功能验证记录表"},
        {"id":"sat-6-4","item":"充电/放电过流保护(200/220/240A)","content":"模拟充/放电电流超限，验证保护分级动作（轻微降流50%→中度禁止→严重3s跳机）","standard":"GB/T 34131-2017 §12.2-14/15","type":"关键","tool":"BAMS显示屏/钳形电流表(1000A)","record":"保护功能验证记录表"},
        {"id":"sat-6-5","item":"充/放电高温保护(45/50/55/60℃)","content":"加热或模拟温度超各阈值，验证阶梯降额/停机逻辑","standard":"GB/T 34131-2017 §12.2-4/6","type":"关键","tool":"BAMS显示屏/红外测温仪","record":"保护功能验证记录表"},
        {"id":"sat-6-6","item":"充/放电低温保护(10/5/0/-20℃)","content":"模拟低温场景，验证保护动作","standard":"GB/T 34131-2017 §12.2-5/7","type":"重要","tool":"BAMS显示屏","record":"保护功能验证记录表"},
        {"id":"sat-6-7","item":"单体电压压差保护(300/400/500mV)","content":"模拟单体压差超限，验证告警/禁止充放/跳机","standard":"GB/T 34131-2017 §12.2-3","type":"关键","tool":"BAMS显示屏","record":"保护功能验证记录表"},
        {"id":"sat-6-8","item":"簇间温差大保护(10/15/20℃)","content":"模拟簇间温差超限，验证保护分级动作","standard":"GB/T 34131-2017 §12.2-8","type":"重要","tool":"BAMS显示屏","record":"保护功能验证记录表"},
        {"id":"sat-6-9","item":"SOC过高/过低保护(95/100% / 10/0%)","content":"模拟SOC越限，验证保护动作","standard":"GB/T 34131-2017 §12.2-9/10","type":"重要","tool":"BAMS显示屏","record":"保护功能验证记录表"},
        {"id":"sat-6-10","item":"绝缘低保护(1000/500/100KΩ)","content":"模拟绝缘阻抗下降，验证保护分级动作","standard":"GB/T 34131-2017 §12.2-16","type":"关键","tool":"绝缘测试仪/BAMS显示屏","record":"保护功能验证记录表"},
        {"id":"sat-6-11","item":"簇间电流差保护(10/30/50A)","content":"模拟簇间电流差超阈值，验证三级保护（告警→禁充放→3s跳机）","standard":"需求确认表 §12.5","type":"关键","tool":"BAMS显示屏/钳形电流表","record":"保护功能验证记录表"},
        {"id":"sat-6-12","item":"显控-主控通讯故障保护","content":"断开显控与主控通讯，验证中度告警→禁止充放→恢复","standard":"需求确认表 §12.4","type":"重要","tool":"上位机","record":"保护功能验证记录表"},
        {"id":"sat-6-13","item":"主控-从控通讯故障保护","content":"断开主控-从控CAN通讯，验证严重告警→3s跳机","standard":"需求确认表 §12.2-18","type":"关键","tool":"ZLG CAN盒","record":"保护功能验证记录表"},
        {"id":"sat-6-14","item":"断路器/接触器故障保护","content":"模拟断路器反馈异常/接触器粘连，验证严重告警→跳机","standard":"需求确认表 §12.2-21/23","type":"关键","tool":"BAMS显示屏","record":"保护功能验证记录表"},
        {"id":"sat-6-15","item":"反极性保护","content":"模拟电池组反接，验证硬件保护动作","standard":"GB/T 34131-2017","type":"重要","tool":"万用表","record":"保护功能验证记录表"},
        {"id":"sat-6-16","item":"通信中断保护(BMS-PCS)","content":"断开BMS-PCS通讯，验证停机策略执行","standard":"GB/T 34131-2017","type":"重要","tool":"上位机","record":"保护功能验证记录表"},
        {"id":"sat-6-17","item":"直流绝缘监测功能","content":"模拟单点接地故障，检测BMS报警响应","standard":"GB/T 34131-2017","type":"一般","tool":"BAMS显示屏","record":"绝缘监测记录表"},
        {"id":"sat-6-18","item":"霍尔传感器故障/通讯故障保护","content":"模拟霍尔传感器异常（|I1-I2|≥10A），验证电流检测故障保护","standard":"需求确认表 §12.2-25/26","type":"关键","tool":"BAMS显示屏","record":"保护功能验证记录表"}
      ],"witness":"研发人员"},
      {"id":"sat-7","sortOrder":7,"name":"7. 并网试验","steps":["同期并网","BAU一键并网","功率调节","保护联调","电能质量","急停/F-Stop"],"checks":[
        {"id":"sat-7-1","item":"同期并网条件核验","content":"调整PCS输出与电网同期:电压差<5%、频率差<0.1Hz、相序一致","standard":"GB/T 19939-2005","type":"关键","tool":"电能质量分析仪","record":"并网试验记录表"},
        {"id":"sat-7-2","item":"BAU复位与一键并网","content":"BAU复位可靠性验证，并网冲击电流<1.5倍额定，响应时间≤3s，重复3次","standard":"SAT方案 §4.2","type":"关键","tool":"BAMS显示屏/电能质量分析仪","record":"并网试验记录表"},
        {"id":"sat-7-3","item":"有功/无功调节(AGC/AVC)","content":"AGC/AVC指令下有功/无功响应正确，调节范围满足要求","standard":"GB/T 19964-2012","type":"重要","tool":"上位机/调度模拟"," record":"功率调节记录表"},
        {"id":"sat-7-4","item":"防孤岛保护动作时间","content":"断开并网点，测量脱网时间≤2s，PCS可靠停机","standard":"GB/T 29319-2012","type":"关键","tool":"电能质量分析仪/秒表","record":"防孤岛测试记录表"},
        {"id":"sat-7-5","item":"低电压穿越LVRT(推荐)","content":"模拟电网电压跌落，验证不脱网运行能力","standard":"GB/T 19963-2021","type":"推荐","tool":"电网模拟源","record":"LVRT测试报告"},
        {"id":"sat-7-6","item":"频率响应特性","content":"电网频率变化时系统有功/无功响应正确","standard":"GB/T 19862-2016","type":"重要","tool":"上位机/电能质量分析仪","record":"频率响应记录表"},
        {"id":"sat-7-7","item":"电能质量检测(THD等)","content":"用电能质量分析仪测THD/频率偏差/三相不平衡度等指标","standard":"GB/T 14549-93","type":"重要","tool":"电能质量分析仪","record":"电能质量检测报告"},
        {"id":"sat-7-8","item":"远方/就地切换功能","content":"远方模式:BMS可合闸;就地模式:BMS无法合闸","standard":"GB/T 36547-2018","type":"重要","tool":"BAMS显示屏/汇流柜旋钮","record":"远方就地测试记录表"},
        {"id":"sat-7-9","item":"急停/E-Stop联动测试","content":"按下急停按钮→汇流柜高压回路断开→BMS显示急停告警","standard":"GB/T 36547-2018","type":"关键","tool":"BAMS显示屏/万用表","record":"急停测试记录表"},
        {"id":"sat-7-10","item":"并网后故障诊断与恢复","content":"稳定运行10min后执行全系统故障检查，24h稳定性测试故障频次≤1次/8h","standard":"SAT-SOP(FU) §9.3","type":"重要","tool":"上位机/Wireshark","record":"故障诊断报告"}
      ],"witness":"调度/电网公司"},
      {"id":"sat-8","sortOrder":8,"name":"8. 72h试运行","steps":["连续运行监控","每日巡检","性能统计","故障分析","报告签署"],"checks":[
        {"id":"sat-8-1","item":"连续72h运行无重大故障","content":"按调度指令执行自动充放电循环，无人强制停机，无重大故障、无保护误动作、无脱网","standard":"GB/T 36547-2018","type":"关键","tool":"EMS系统/BMS上位机","record":"试运行日报(×7)"},
        {"id":"sat-8-2","item":"系统可用率检测","content":"统计72h内实际运行时间占比≥99%（或按合同约定≥95%）","standard":"GB/T 36547-2018","type":"关键","tool":"EMS系统","record":"可用率统计表"},
        {"id":"sat-8-3","item":"每日人工巡检记录","content":"每小时人工巡检:电气参数/电池参数(SOC/SOH/T)/热管理/环境参数/通信状态","standard":"SAT方案 §5","type":"关键","tool":"巡检记录表/红外测温仪","record":"巡检记录表(×7)"},
        {"id":"sat-8-4","item":"平均无故障时间(MTBF)检测","content":"统计两次故障间隔时间，MTBF满足设计要求","standard":"GB/T 36547-2018","type":"重要","tool":"EMS系统","record":"MTBF统计表"},
        {"id":"sat-8-5","item":"故障统计与分析","content":"分类统计72h内所有告警/故障事件，生成事件分级(I~IV级)报告","standard":"SAT方案 §9","type":"重要","tool":"EMS系统/BAMS显示屏","record":"故障统计分析报告"},
        {"id":"sat-8-6","item":"热成像全场巡检","content":"热成像仪扫描全场热点分布，无异常温升>15K","standard":"GB/T 19964-2012","type":"重要","tool":"红外测温仪(-20~500℃)","record":"热成像巡检报告"},
        {"id":"sat-8-7","item":"噪音水平检测","content":"在厂界处测量噪音:昼≤60dB(A)/夜≤55dB(A)","standard":"GB 12348-2008","type":"重要","tool":"声级计","record":"噪音检测报告"},
        {"id":"sat-8-8","item":"试运行报告签署(三方)","content":"三方(业主/调试方/运维)签署72h试运行合格报告","standard":"GB/T 36995-2019","type":"关键","tool":"—","record":"试运行验收证书"},
        {"id":"sat-8-9","item":"数据完整性归档","content":"收集7天所有日报/故障记录/巡检报告/热成像图/电能质量报表，归档备查","standard":"GB/T 36995-2019","type":"重要","tool":"—","record":"试运行归档清单"}
      ],"witness":"业主代表/运维团队"}
    ],
    "sevenM1E":{"人":"调试总工、BMS/EMS工程师、持证电工","机":"绝缘电阻测试仪(MIT525)、耐压测试仪、功率分析仪、热成像仪、ZLG CAN盒(USBCAN-2E-U)、数显扭矩扳手(CNB100)、数字万用表(1500VDC)、钳形电流表(1000A)、网线测试仪、消防烟枪","料":"测试记录表全套、校准证书、备品备件清单、安全警示带/牌","法":"GB/T 36547/36995/37593/34131 + 厂家操作规程 + SAT合规性确认","环":"环境温度0-45℃、湿度<95%RH、电网电压波动±10%","测":"绝缘电阻、接地电阻、保护动作时间、充放电效率、容量衰减、温升、THD、频率响应","管理":"项目经理到岗、安全员持证、班前会交底、作业票签发、JSA工作安全分析、高压作业许可","能源":"临时用电三级箱配置、线缆载流核算、动火作业审批(二级动火)、受限空间许可(进入DC舱前气体检测)"}
  };
    ...
    try {
      ...
      if (saved) {
        ...
        if (parsed && parsed._version === STORAGE_VERSION && parsed.projects && Array.isArray(parsed.projects) && parsed.projects.length > 0) {
          ...
          if (!parsed.satSOP || !parsed.satSOP.phases) parsed.satSOP = EMBEDDED_SAT_SOP;

  ...
  "outline": [
    {
      ...
      "target": "交付/调试/售前工程师",
      "content": [
        "储能系统基本构成：电池模组、PCS、BMS、EMS、消防与液冷",
        "电化学储能工作原理：锂电充放电特性与能量转换",
        "PCS功能：交直流变换、并网/离网、有功无功调节",
        "BMS作用：电芯监控、均衡、保护、SOC/SOH估算",
        "EMS调度：峰谷套利、需量管理、调度指令响应"
      ],
      "questions": [
        {
          "type": "single",
  ...
  "materials": [
    {
      ...
      "type": "ppt",
      "courseId": "c1",
      "fileName": "储能基础原理.pptx",
      "sizeKB": 2048,
      "updatedAt": "2026-07-05",
      "note": "内部培训用（示例条目，未上传实际文件）"
    },
    {
      "id": "m2",
      "title": "客户运维操作手册V1.0",
      "type": "doc",
      "courseId": "c5",
      "fileName": "运维操作手册.docx",
      "sizeKB": 512,
      "updatedAt": "2026-07-06",
      "note": "交付客户（示例条目，未上传实际文件）"
    }
  ],
  "exams": [],
  "submissions": [],
